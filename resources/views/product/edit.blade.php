                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="name" id="name" value="{{ $product['name'] }}" class="border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>

                        <div class="flex flex-col">
                            <label for="price" class="text-gray-700 font-medium">Price (Rp.) :</label>
                            <input type="number" name="price" id="price" value="{{ $product['price'] }}" class="border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="number" name="stock" id="stock" value="{{ $product['stock'] }}" class="border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
                    </div>
                </div>
