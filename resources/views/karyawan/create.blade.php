...
@section('container-content')
    <div class="my-2.5 mx-auto p-6 bg-white shadow-md rounded-lg">
        <div class="bg-white shadow-md rounded-lg max-w-3xl mx-auto p-5">
            ...
            <form action="{{ route('karyawan.add_karyawan_page') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @if ($errors->any())
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="flex justify-center">
                        <img id="image-preview" class="h-96 object-cover mb-4 border-2 border-gray-200" alt="Image Preview" src="https://placehold.co/200x200" />
                    </div>

                    <div class="space-y-4">
                        <div class="flex flex-col">
                            <label for="name" class="text-gray-700 font-medium">Name :</label>
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Masukkan nama karyawan" class="border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 font-sans">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="file" id="image" name="image" class="border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 font-sans" onchange="previewImage(event)">
                        </div>
                    </div>
                </div>
